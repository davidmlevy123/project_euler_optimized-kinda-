...
int main() {
	...
	while (!stop) {
		...
		case 13: answers::Q13(); break;
		case 14: answers::Q14(); break;
		...
		case -1: {
			...
			while (!stop_test)
			{
				...
				case 13: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q13", answers_for_testing::Q13, num_of_tests);
					break;
				}
				case 14: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q14", answers_for_testing::Q14, num_of_tests);
					break;
				}
				case 15: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q15", answers_for_testing::Q15, num_of_tests);
					break;
				}
				case 16: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q16", answers_for_testing::Q16, num_of_tests);
					break;
				}
				case 17: {
					cout << "enter amount of tests: ";
				...
				case 19: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q19", answers_for_testing::Q19, num_of_tests);
					break;
				}
				case 20: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q20", answers_for_testing::Q20, num_of_tests);
					break;
				}
				case 21: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q21", answers_for_testing::Q21, num_of_tests);
					break;
				}
				case 22: {
					cout << "enter amount of tests: ";
				...
				case 27: {
					cout << "enter amount of tests: ";
					cin >> num_of_tests;
					Utils::Benchmarker::MeasureAndPrint("Q27", answers_for_testing::Q27, num_of_tests);
					break;
				}
				case 28: {
					cout << "enter amount of tests: ";
